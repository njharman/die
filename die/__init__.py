...
__email__    = "njharman@knoggin.com"
__url__      = "http://www.friendorfoe.com/die/"
__version__  = "0.1"
...
along with this program; if not, write to the FSF, Inc.,
...
""" % {'name':__name__, 'version':__version__, 'copyright':__copyright__,
       'license':__license__, 'url':__url__, 'email':__email__, 'author':__author__}

from die import Standard, Numeric, NumericBased, Weird
